...
namespace WorldofValheimZones
{
    ...
    public static class Client
    {
        ...
        // Messages on zone change
        public static bool MessageAnnoucement = true;
        // The message of zone change will be send (TRUE) or not (FALSE)
        ...
        public static void _debug()
        {
            ...
            Debug.Log(" MessageAnnoucement: " + Client.MessageAnnoucement);
        }
#endif
        ...
        public static ZPackage Serialize(string SteamID)
        {
            ...
            zip.Write(Client.MessageAnnoucement);
        ...
        public static void Deserialize(ZPackage data)
        {
            ...
            Client.MessageAnnoucement = data.ReadBool();
